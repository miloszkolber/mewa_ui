...
Spinner uses primary text color by default.

Spinner inherits text color inside buttons and busy links so the indicator remains readable inside inverted actions.
