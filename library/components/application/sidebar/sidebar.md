...
<button class="btn"
        type="button"
        data-variant="ghost" data-icon-only
...
The shortcut requires an enhanced Sidebar in the current document.

The shortcut does not override text editing, composition, or a canceled keyboard event.
