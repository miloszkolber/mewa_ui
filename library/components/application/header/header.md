...
<header class="header">
  <div class="header-inner">
    ...
    <div class="header-actions">
      <a class="btn" data-variant="secondary" href="/support">Support</a>
    </div>
  </div>
</header>
```
...
Apply `.btn` to action links and buttons. Load Button styles for this composition. Header preserves the Button variant and its 36px height.
