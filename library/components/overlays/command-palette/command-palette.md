...
<dialog id="command-menu"
  ...
  <div class="command-palette-content">
    ...
    <div class="command-palette-list" id="command-menu-list" aria-label="Commands">
...
The module assigns `role="combobox"`, `aria-autocomplete="list"`, `aria-controls`, and `aria-expanded` to the search input.

The module assigns `role="listbox"` to the command list and `role="option"` to command buttons.

The module labels each `role="group"` from its group heading unless the group has an authored label.
...
Closing returns focus to the previous control when the shortcut opened the palette.
...
Cleanup restores authored roles, IDs, visibility, and focus attributes unless the application replaces a managed value.
