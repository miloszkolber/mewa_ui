...
function bindMenu(trigger, state, menu) {
  ...
  const menuAnchor = menu.style.positionAnchor;
  ...
  state.unbindMenu = () => {
    ...
    if (menu.style.positionAnchor === anchorId) menu.style.positionAnchor = menuAnchor;
    if (trigger.getAttribute('aria-expanded') === currentExpanded) {
