...
Keep the full native input pointer-operable. Show keyboard focus around the complete input. Disabled presentation applies to the filename region and selector button.
