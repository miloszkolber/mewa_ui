...
The ready Slider uses a 4px track and 16px thumb inside a 36px interaction area. Disabled thumbs use explicit disabled surface and border roles. Do not blur the control.
