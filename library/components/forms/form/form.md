...
<form class="form" method="post" action="/profile">
  ...
  <div class="form-actions">
    <button class="btn" type="submit" data-variant="primary">Save changes</button>
...
Horizontal fields stack at the narrow breakpoint. Form actions wrap when the available width cannot fit the action group.
