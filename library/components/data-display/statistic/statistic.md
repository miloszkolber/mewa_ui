...
```html
<div class="statistic">
  <p class="statistic-title">Completed jobs</p>
  <p class="statistic-value">3</p>
  <p class="statistic-description">
    <span class="statistic-trend" data-trend="down">
      <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M13.0001 16.1716L18.3641 10.8076L19.7783 12.2218L12.0001 20L4.22192 12.2218L5.63614 10.8076L11.0001 16.1716V4H13.0001V16.1716Z"/></svg>
      25 percent fewer
    </span>
    than yesterday
  </p>
...
The current `up` treatment uses positive color and the `down` treatment uses negative color.

Omit `data-trend` when an increase is undesirable or a decrease is desirable.

Use explicit neutral comparison text for those metrics instead of applying misleading status color.
