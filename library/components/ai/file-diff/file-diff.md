...
<details class="file-diff" open>
  <summary class="file-diff-trigger">
    ...
    <span class="file-diff-counts" aria-label="1 addition and 1 deletion">
      <span class="file-diff-additions">+1</span>
  ...
  <div class="file-diff-viewport" role="region" aria-label="File changes" tabindex="0">
    <table class="file-diff-table">
      <caption class="file-diff-caption">Changes to src/session.js: 1 addition and 1 deletion.</caption>
...
Give the overflow viewport an accessible name and `tabindex="0"` when keyboard scrolling requires a focus target.
