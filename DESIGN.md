...
- Opaque scales increase monotonically and remain in sRGB. Corresponding steps share the exact gray-defined OKLCH lightness curve from `L 17.7` to `L 94.5`. Gray steps `500`–`900` target `Lc 15`, `30`, `45`, `60`, and `75` against gray `050`; gray `950` reaches approximately `Lc 95`.
- Red, amber, and green hold fixed hues of `17`, `75`, and `145`. Each family uses its own reference-shaped chroma curve, increasing toward the useful middle of the scale and tapering near the dark and light endpoints. Rendered APCA values may differ by family because hue and chroma affect sRGB luminance. Light-on-dark values have negative APCA polarity.
