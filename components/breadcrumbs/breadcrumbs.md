...
- Links keep native `:focus-visible` styling and the trail has no scripted focus management.
- Navigation updates are immediate. This component adds no animation, transition, or smooth scrolling.
